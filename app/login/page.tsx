...
export default function LoginPage() {
    ...
    return (
        <div className="min-h-screen relative flex items-center justify-center bg-gradient-to-br from-gray-100 via-white to-teal-50 p-4 overflow-hidden">
            {/* Decorative blurred blobs */}
            <div className="pointer-events-none absolute -top-32 -left-32 w-80 h-80 bg-teal-200/40 rounded-full blur-3xl" />
            <div className="pointer-events-none absolute bottom-0 -right-20 w-96 h-96 bg-emerald-200/40 rounded-full blur-3xl" />
            <div className="w-full max-w-md relative z-10 rounded-3xl bg-gradient-to-br from-teal-200/60 via-white to-emerald-100/40 p-[1px] shadow-xl">
                <Card className="w-full p-8 md:p-10 space-y-7 bg-white/85 backdrop-blur-xl border border-white/40 shadow-inner relative z-10 rounded-[inherit]">
